...
namespace CurriculumVitaeOntology
{
	public class CV : GnossOCBase
	{
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			{
				list.Add($"<{resourceAPI.GraphsUrl}items/TelephoneType_{ResourceID}_{item2.ArticleID}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <https://www.w3.org/2006/vcard/ns#TelephoneType> . ");
				list.Add($"<{resourceAPI.GraphsUrl}items/TelephoneType_{ResourceID}_{item2.ArticleID}> <http://www.w3.org/2000/01/rdf-schema#label> \"https://www.w3.org/2006/vcard/ns#TelephoneType\" . ");
				list.Add($"<{resourceAPI.GraphsUrl}{ResourceID}> <http://gnoss/hasEntidad> <{resourceAPI.GraphsUrl}items/TelephoneType_{ResourceID}_{item2.ArticleID}> . ");
				list.Add($"<{resourceAPI.GraphsUrl}items/PersonalData_{ResourceID}_{this.Roh_personalData.ArticleID}> <https://www.w3.org/2006/vcard/ns#hasTelephone> <{resourceAPI.GraphsUrl}items/TelephoneType_{ResourceID}_{item2.ArticleID}> . ");
				if(item2.Roh_hasExtension != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/TelephoneType_{ResourceID}_{item2.ArticleID}> <http://w3id.org/roh/hasExtension> \"{item2.Roh_hasExtension.Replace("\r\n", " ").Replace("\n", " ").Replace("\r", " ").Replace("\"", "\\\"")}\" . ");
				}
				if(item2.Roh_hasInternationalCode != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/TelephoneType_{ResourceID}_{item2.ArticleID}> <http://w3id.org/roh/hasInternationalCode> \"{item2.Roh_hasInternationalCode.Replace("\r\n", " ").Replace("\n", " ").Replace("\r", " ").Replace("\"", "\\\"")}\" . ");
				}
				if(item2.Vcard_hasValue != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/TelephoneType_{ResourceID}_{item2.ArticleID}> <https://www.w3.org/2006/vcard/ns#hasValue> \"{item2.Vcard_hasValue.Replace("\r\n", " ").Replace("\n", " ").Replace("\r", " ").Replace("\"", "\\\"")}\" . ");
				}
			}
			}
			...
			{
				list.Add($"<{resourceAPI.GraphsUrl}items/Document_{ResourceID}_{item4.ArticleID}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://xmlns.com/foaf/0.1/Document> . ");
				list.Add($"<{resourceAPI.GraphsUrl}items/Document_{ResourceID}_{item4.ArticleID}> <http://www.w3.org/2000/01/rdf-schema#label> \"http://xmlns.com/foaf/0.1/Document\" . ");
				list.Add($"<{resourceAPI.GraphsUrl}{ResourceID}> <http://gnoss/hasEntidad> <{resourceAPI.GraphsUrl}items/Document_{ResourceID}_{item4.ArticleID}> . ");
				list.Add($"<{resourceAPI.GraphsUrl}items/PersonalData_{ResourceID}_{this.Roh_personalData.ArticleID}> <http://vivoweb.org/ontology/core#researcherId> <{resourceAPI.GraphsUrl}items/Document_{ResourceID}_{item4.ArticleID}> . ");
				if(item4.Foaf_topic != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/Document_{ResourceID}_{item4.ArticleID}> <http://xmlns.com/foaf/0.1/topic> \"{item4.Foaf_topic.Replace("\r\n", " ").Replace("\n", " ").Replace("\r", " ").Replace("\"", "\\\"")}\" . ");
				}
				if(item4.Dc_title != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/Document_{ResourceID}_{item4.ArticleID}> <http://purl.org/dc/elements/1.1/title> \"{item4.Dc_title.Replace("\r\n", " ").Replace("\n", " ").Replace("\r", " ").Replace("\"", "\\\"")}\" . ");
				}
				if(item4.Foaf_primaryTopic != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/Document_{ResourceID}_{item4.ArticleID}> <http://xmlns.com/foaf/0.1/primaryTopic> \"{item4.Foaf_primaryTopic.Replace("\r\n", " ").Replace("\n", " ").Replace("\r", " ").Replace("\"", "\\\"")}\" . ");
				}
			}
			}
			...
			{
			foreach(var item1 in this.Roh_scientificExperience.Roh_nonCompetitiveProjects)
			{
				...
				list.Add($"<{resourceAPI.GraphsUrl}items/ScientificExperience_{ResourceID}_{this.Roh_scientificExperience.ArticleID}> <http://w3id.org/roh/nonCompetitiveProjects> <{resourceAPI.GraphsUrl}items/RelatedProjects_{ResourceID}_{item1.ArticleID}> . ");
			...
			{
				list.Add($"<{resourceAPI.GraphsUrl}items/RelatedProjects_{ResourceID}_{item2.ArticleID}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://w3id.org/roh/RelatedProjects> . ");
				list.Add($"<{resourceAPI.GraphsUrl}items/RelatedProjects_{ResourceID}_{item2.ArticleID}> <http://www.w3.org/2000/01/rdf-schema#label> \"http://w3id.org/roh/RelatedProjects\" . ");
				list.Add($"<{resourceAPI.GraphsUrl}{ResourceID}> <http://gnoss/hasEntidad> <{resourceAPI.GraphsUrl}items/RelatedProjects_{ResourceID}_{item2.ArticleID}> . ");
				list.Add($"<{resourceAPI.GraphsUrl}items/ScientificExperience_{ResourceID}_{this.Roh_scientificExperience.ArticleID}> <http://w3id.org/roh/competitiveProjects> <{resourceAPI.GraphsUrl}items/RelatedProjects_{ResourceID}_{item2.ArticleID}> . ");
				if(item2.IdVivo_relatedBy != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/RelatedProjects_{ResourceID}_{item2.ArticleID}> <http://vivoweb.org/ontology/core#relatedBy> <{item2.IdVivo_relatedBy}> . ");
				}
				if(item2.Roh_order != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/RelatedProjects_{ResourceID}_{item2.ArticleID}> <http://w3id.org/roh/order> {item2.Roh_order.ToString()} . ");
				}
				if(item2.Roh_isPublic != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/RelatedProjects_{ResourceID}_{item2.ArticleID}> <http://w3id.org/roh/isPublic> \"{item2.Roh_isPublic.ToString()}\" . ");
				}
			}
			}
			}
		...
		public override List<string> ToSearchGraphTriples(ResourceApi resourceAPI)
		{
			...
			foreach(var item2 in this.Roh_scientificExperience.Roh_competitiveProjects)
			{
				...
				if(item2.IdVivo_relatedBy != null)
				{
					...
					list.Add($"<{resourceAPI.GraphsUrl}items/relatedprojects_{ResourceID}_{item2.ArticleID}> <http://vivoweb.org/ontology/core#relatedBy> <{itemRegex}> . ");
				}
				if(item2.Roh_order != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/relatedprojects_{ResourceID}_{item2.ArticleID}> <http://w3id.org/roh/order> {item2.Roh_order.ToString()} . ");
				...
				if(item2.Roh_isPublic != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/relatedprojects_{ResourceID}_{item2.ArticleID}> <http://w3id.org/roh/isPublic> \"{item2.Roh_isPublic.ToString().ToLower()}\" . ");
				}
			}
			}
			}
