	...
	public class MatureState : GnossOCBase
	{
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			AgregarTripleALista($"{resourceAPI.GraphsUrl}{ResourceID}", "http://gnoss/hasEntidad", $"<{resourceAPI.GraphsUrl}items/MatureState_{ResourceID}_{ArticleID}>", list, " . ");
				...
				{
					AgregarTripleALista($"{resourceAPI.GraphsUrl}items/MatureState_{ResourceID}_{ArticleID}",  "http://purl.org/dc/elements/1.1/title", $"\"{GenerarTextoSinSaltoDeLinea(this.Dc_title)}\"", list, " . ");
				}
