...
namespace OrganizationtypeOntology
{
	public class OrganizationType : GnossOCBase
	{
		...
		public override List<string> ToOntologyGnossTriples(ResourceApi resourceAPI)
		{
			...
			list.Add($"<{resourceAPI.GraphsUrl}items/OrganizationType_{ResourceID}_{ArticleID}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://w3id.org/roh/OrganizationType> . ");
			list.Add($"<{resourceAPI.GraphsUrl}items/OrganizationType_{ResourceID}_{ArticleID}> <http://www.w3.org/2000/01/rdf-schema#label> \"http://w3id.org/roh/OrganizationType\" . ");
			list.Add($"<{resourceAPI.GraphsUrl}{ResourceID}> <http://gnoss/hasEntidad> <{resourceAPI.GraphsUrl}items/OrganizationType_{ResourceID}_{ArticleID}> . ");
				if(this.Dc_title != null)
				{
					list.Add($"<{resourceAPI.GraphsUrl}items/OrganizationType_{ResourceID}_{ArticleID}> <http://purl.org/dc/elements/1.1/title> \"{this.Dc_title.Replace("\r\n", " ").Replace("\n", " ").Replace("\r", " ").Replace("\"", "\\\"")}\" . ");
				}
			return list;
		}
