...
namespace DocumentOntology
{
	public class Event : GnossOCBase
	{
		...
		public Event(SemanticEntityModel pSemCmsModel, LanguageEnum idiomaUsuario) : base()
		{
			...
			{
				this.Dc_type = new EventType(propDc_type.PropertyValues[0].RelatedEntity,idiomaUsuario);
			}
		}
		...
		[LABEL(LanguageEnum.es,"Entidad organizadora")]
		...
		[LABEL(LanguageEnum.es,"Fecha de celebración")]
		[RDFProperty("http://vivoweb.org/ontology/core#start")]
		public  DateTime? Vivo_start { get; set;}

		[LABEL(LanguageEnum.es,"Con comité de admisión externo")]
		...
		[LABEL(LanguageEnum.es,"Nombre del evento")]
		[RDFProperty("http://purl.org/dc/elements/1.1/title")]
		public  string Dc_title { get; set;}

		[LABEL(LanguageEnum.es,"Tipo evento")]
		[RDFProperty("http://purl.org/dc/elements/1.1/type")]
		[Required]
		public  EventType Dc_type  { get; set;} 
