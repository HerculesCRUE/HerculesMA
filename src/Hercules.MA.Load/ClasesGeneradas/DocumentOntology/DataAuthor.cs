...
using Motivation = MotivationOntology.Motivation;
...
namespace DocumentOntology
{
	public class DataAuthor : GnossOCBase
	{
		...
		public virtual string RdfType { get { return "http://w3id.org/roh/DataAuthor"; } }
		public virtual string RdfsLabel { get { return "http://w3id.org/roh/DataAuthor"; } }
		public OntologyEntity Entity { get; set; }

		[LABEL(LanguageEnum.es,"Forma de inscripción")]
		...
		{
			base.GetProperties();
			propList.Add(new StringOntologyProperty("roh:motivatedBy", this.IdRoh_motivatedBy));
			...
			propList.Add(new StringOntologyProperty("roh:motivatedByOther", this.Roh_motivatedByOther));
